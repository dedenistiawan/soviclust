                         ...
                         shinydashboard::box(
                           ...
                           tags$p(style = "font-size:12.5px; color:#546e7a; margin-bottom:12px;",
                             ...
                             tags$span(style = "color:#e74c3c; font-weight:600;",
                               ...
                               " Run FGWC (main tab) first before starting stability analysis."
                             )
                           ),

                           fluidRow(
                             column(3,
                               numericInput("fgwc_nruns",
                                 label = tags$span(icon("redo"), " Number of Runs:"),
                                 value = 30, min = 5, max = 100, step = 5)
                             ),
                             column(3,
                               numericInput("fgwc_seed_start",
                                 label = tags$span(icon("random"), " Seed Start:"),
                                 value = 1, min = 0, step = 1)
                             ),
                             column(3,
                               tags$br(),
                               actionButton("fgwc_run_stability",
                             ...
                             column(3,
                               tags$br(),
                               downloadButton("dl_fgwc_stability",
                           ...
                           tags$div(style = "margin-top:10px;",
                             uiOutput("fgwc_stability_progress")
                           )
                         )
                       )
                     ),
                     ...
                     fluidRow(
                       column(12,
                         shinydashboard::box(
                           ...
                           solidHeader = TRUE,
                           width       = 12,
                           DT::dataTableOutput("fgwc_stability_summary")
                         )
                       )
                     ),
                     ...
                     fluidRow(
                       column(12,
                         shinydashboard::box(
                           ...
                           solidHeader = TRUE,
                           width       = 12,
                           plotOutput("fgwc_stability_boxplot", height = "420px")
                         )
                       )
                     ),

                     # Detail per-run table
                     fluidRow(
                       column(12,
                         shinydashboard::box(
                           ...
                           collapsible = TRUE,
                           collapsed   = TRUE,
                           DT::dataTableOutput("fgwc_stability_detail")
                         )
                       )
                     )
